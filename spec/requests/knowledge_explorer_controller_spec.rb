...
describe ChordDirectory::ChordDirectoryController do
  ...
  before do
    ...
    SiteSetting.chord_directory_enabled = true
    SiteSetting.chord_directory_categories = category.id.to_s
    SiteSetting.chord_directory_tags = 'test'
  end
  ...
  describe 'knowledge explorer data' do
    ...
    context 'when some knowledge explorer topics are private' do
      ...
      before do
        SiteSetting.chord_directory_categories = "#{category.id}|#{private_category.id}"
      end
    ...
    context 'when filtering by category' do
      ...
      before do
        SiteSetting.chord_directory_categories = "#{category.id}|#{category2.id}"
      end
